...
class MKT_WORLDCORE extends WC_Payment_Gateway{
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'api_url' => array(
				'title'		=> __( 'Worldcore API Endpoint URL', 'mkt-worldcore' ),
				'type'		=> 'text',
				'desc_tip'	=> __( 'This is the URL of the Worldcore API endpoint.', 'mkt-worldcore' ),
				'default'	=> __( 'https://api.worldcore.eu/v1/merchant', 'mkt-worldcore' ),
				'css'		=> 'max-width:350px;'
			),
			'api_key' => array(
